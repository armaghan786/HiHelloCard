    ...
    public partial class InitialMigration11 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cardfieldcategories", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cardfields_Cardfieldcategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Cardfieldcategories",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Suffix = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Accreditations = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Logo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AffiliateTitle = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usercards_Carddesigns_DesignId",
                        column: x => x.DesignId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BadgePath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CardId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usercardbadges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Usercardbadges_Usercards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CardFieldId = table.Column<int>(type: "int", nullable: true),
                    CardId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usercardfields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Usercardfields_Cardfields_CardFieldId",
                        column: x => x.CardFieldId,
                        principalTable: "Cardfields",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Usercardfields_Usercards_CardId",
                        column: x => x.CardId,
                        principalTable: "Usercards",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cardfields_CategoryId",
                table: "Cardfields",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Usercardbadges_CardId",
                table: "Usercardbadges",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_Usercardfields_CardFieldId",
                table: "Usercardfields",
                column: "CardFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_Usercardfields_CardId",
                table: "Usercardfields",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_Usercards_DesignId",
                table: "Usercards",
                column: "DesignId");
